...
export const commentKeys = {
  ...
  list: (taskId: string, params?: Record<string, any>) =>
...
export const useCreateComment = (taskId: string) => {
  ...
  return useMutation({
    mutationFn: (commentData: CreateCommentRequest) =>
      TaskCommentsService.createComment(taskId, commentData),
    onSuccess: (newComment: TaskComment) => {
      ...
      queryClient.setQueryData(commentKeys.list(taskId), (oldData: any) => {
...
export const useDeleteComment = (taskId: string) => {
  ...
  return useMutation({
    mutationFn: (commentId: string) =>
      TaskCommentsService.deleteComment(taskId, commentId),
